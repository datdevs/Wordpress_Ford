					...
					<div class="form-content">						
								...
								<div class="col-md-9 col-content col-border-bottom">
									<p>
										<label for="enabled_font_opensans">
											...
											<?php echo sprintf(__('Using <a href="%s" target="_blank">Open Sans Font</a>.', 'chat-bubble'), 'https://fonts.google.com/specimen/Open+Sans?preview.text_type=custom'); ?>
										</label>	
									</p>
								</div>
							</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-9 col-content col-border-bottom">									
									<input name="color" type="color" id="color" placeholder="#e77f11" class="regular-text code form-control" style="max-width: 25rem;" value="<?php echo (isset($color)) ? esc_attr(stripslashes($color)) : '#e77f11'; ?>" />
					...
					<div class="form-content">	
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-9 col-content col-border-bottom">
									<p>
										<label for="enabled_greeting_title">
											<input name="enabled_greeting_title" type="hidden" value="0" />
											<input id="enabled_greeting_title" name="enabled_greeting_title" type="checkbox" class="form-control" value="1" <?php echo ($enabled_greeting_title === 1) ? 'checked' : ''; ?> />
											<?php _e('Use Greeting title.', 'chat-bubble'); ?>
										</label>	
									</p>
