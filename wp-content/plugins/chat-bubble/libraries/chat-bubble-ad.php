		...
		public static function get_fields() {
			$fields = array(
				'phone' => array(
					...
					'default_icon' => plugins_url('chat-bubble'.'/assets/images/calling.svg'),
					'fields' => array(
						array(
							'type' => 'checkbox',
							'name' => 'enabled',
				...
				'url' => array(
					...
					'default_icon' => plugins_url('chat-bubble'.'/assets/images/awwwards.svg'),
					'fields' => array(
						array(
							'type' => 'checkbox',
							'name' => 'enabled',
				...
				'email' => array(
					...
					'default_icon' => plugins_url('chat-bubble'.'/assets/images/mailto.svg'),
					'fields' => array(
						array(
							'type' => 'checkbox',
							'name' => 'enabled',
				...
				'messenger' => array(
					...
					'default_icon' => plugins_url('chat-bubble'.'/assets/images/fbmessenger.svg'),
					'fields' => array(
						array(
							'type' => 'checkbox',
							'name' => 'enabled',
				...
				'telegram' => array(
					...
					'default_icon' => plugins_url('chat-bubble'.'/assets/images/telegram.svg'),
					'fields' => array(
						array(
							'type' => 'checkbox',
							'name' => 'enabled',
				...
				'line' => array(
					...
					'default_icon' => plugins_url('chat-bubble'.'/assets/images/line.svg'),
					'fields' => array(
						array(
							'type' => 'checkbox',
							'name' => 'enabled',
				...
				'skype' => array(
					...
					'default_icon' => plugins_url('chat-bubble'.'/assets/images/skype.svg'),
					'fields' => array(
						array(
							'type' => 'checkbox',
							'name' => 'enabled',
				...
				'viber' => array(
					...
					'default_icon' => plugins_url('chat-bubble'.'/assets/images/viber.svg'),
					'fields' => array(
						array(
							'type' => 'checkbox',
							'name' => 'enabled',
				...
				'whatsapp' => array(
					...
					'default_icon' => plugins_url('chat-bubble'.'/assets/images/whatsapp.svg'),
					'fields' => array(
						array(
							'type' => 'checkbox',
							'name' => 'enabled',
				...
				'zalo' => array(
					...
					'default_icon' => plugins_url('chat-bubble'.'/assets/images/zalo.svg'),
					'fields' => array(
						array(
							'type' => 'checkbox',
							'name' => 'enabled',
				...
				'tawkto' => array(
					...
					'default_icon' => plugins_url('chat-bubble'.'/assets/images/tawkto.svg'),
					'fields' => array(
						array(
							'type' => 'checkbox',
							'name' => 'enabled',
				...
				'callback_simple' => array(
					...
					'fields' => array(
						...
						array(
							'type' => 'text',
							'name' => 'submit_lbl',
							'title' => __('Sutmit button', 'chat-bubble'),
				...
				'callback_advanced' => array(
					...
					'fields' => array(
						...
						array(
							...
							'title' => __('Sutmit button', 'chat-bubble'),
							'placeholder' => __('Enter form submit button of Call me later.', 'chat-bubble'),
							'default_value' => __('Sutmit', 'chat-bubble'),
						),
						array(
							'type' => 'desc',
