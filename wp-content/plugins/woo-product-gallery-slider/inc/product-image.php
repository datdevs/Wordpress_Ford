...
<div class="<?php echo esc_attr(implode(' ', array_map('sanitize_html_class', $wrapper_classes))); ?>" <?php echo esc_attr($slider_rtl == 'true' ? 'dir=rtl'  : ''); ?>>
    ...
    if (has_post_thumbnail()) {
        echo '<div class="wpgs-for swiper-container fnt-product-image-full-swiper">';
        echo '<div class="swiper-wrapper align-items-center align-items-md-unset">';
        ...
        echo '<div class="swiper-slide"><div class="fnt-product-detail-img d-flex align-items-center justify-content-center"
    data-caption="' . $img_caption . '" 
    data-fancybox="wpgs-lightbox" href="' . $lightbox_src['url'] . '" 
    data-mobile=["clickContent:close","clickSlide:close"]  
    data-hash="false" >' . $image . '</div></div>';
        ...
        if ($attachment_ids) {
            foreach ($attachment_ids as $attachment_id) {
                ...
                echo '<div class="swiper-slide"><div class="fnt-product-detail-img d-flex align-items-center justify-content-center" data-fancybox="wpgs-lightbox" 
            data-caption="' . $img_caption . '" 
